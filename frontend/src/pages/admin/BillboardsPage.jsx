  ...
  return (
    <AdminShell title="Billboards">
      <div className="section-header">
        <p className="muted">{billboards.length} billboards</p>
        {!editing && (
        ...
        <div className="card mb-4">
          <div className="card-body">
            <form onSubmit={handleSubmit}>
              <h3 className="section-title">{editing.id ? 'Edit billboard' : 'New billboard'}</h3>
                ...
                return (
                  <tr key={b.id}>
                    ...
                    <td>
                      ...
                      {warning === 'expired' && <span style={{ marginLeft: 6, color: '#b91c1c', fontWeight: 600, fontSize: 12 }}>EXPIRED</span>}
                      {warning === 'near-expiry' && <span style={{ marginLeft: 6, color: '#b45309', fontWeight: 600, fontSize: 12 }}>expiring soon</span>}
                    </td>
